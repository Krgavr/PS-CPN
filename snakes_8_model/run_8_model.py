...
net.draw("snakes_8_model/ex1.png", engine="dot")
...
while step < max_steps:
    ...
    for transition in net.transition():
        ...
        if modes:
            ...
            output_path = f"snakes_8_model/img/step_{step + 1}_{transition.name}.png"
...
net.draw("snakes_8_model/ex2.png", engine="dot")
